...
!         with two independent lattice parameters A and C given             *
...
!****************************************************************************
      ...
      subroutine get_en( lambda_a, lambda_c, energy )
          use mod_precision
      ...
      real(dp) ::  lambda_a, lambda_c, energy
...
!  Creating the strained block.
      ...
      a( 1, 1 ) = a1( 1, 1 ) * lambda_a
      a( 2, 2 ) = a1( 2, 2 ) * lambda_a
      a( 3, 3 ) = a1( 3, 3 ) * lambda_c
...
!  Calculate the energy of the strained configuration.
