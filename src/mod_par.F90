   ...
   contains
      ...
      subroutine exec_vlvec_ir_allgather(tpack,iproc,aproc,root,mpmap,n,vlvec,ierr)
         ...
         integer, allocatable :: szs(:)

         allocate(szs(0:aproc-1))
         szs = mpmap(1:aproc) - mpmap(0:aproc-1)

         call mpi_allgatherv(mpi_in_place, 0, mpi_datatype_null, vlvec, szs, mpmap, mpi_real8, mpi_comm_world, ierr)
