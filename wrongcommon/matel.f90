      ...
      subroutine matel(z1,z2,dr,subh,de,scf,tb)
...
!       real(dp) :: bndscl(14,15,mbtype)
      ...
      integer :: llist1(ml), llist2(ml),tb
...
!
      if (tb == 0) then
          ...
          call tbstates(z1,nl1,nstt1,llist1)
          call tbstates(z2,nl2,nstt2,llist2)
      endif
...
! 
         ...
         call eval_rfun(z1, z2, magdr, 0, rfun,tb)
