      subroutine qmix(qmx,nbas,nsp,qmpol,nlmq,rms,it,mmix,b,wc)
...
! C Passed Parameters
      ...
      real(dp) :: qmx(nbas,0:mmix+1,2),qmpol(9, nbas)
      real(dp) :: rms,wc
! C Local Variables
...
! C --- check for charge neutrality ---
      ...
      if (dabs(dqtot) .gt. 0.0_dp) then
          print *, ' QMIX: adding q=',-dqtot,' to conserve charge'
        dqtot = dqtot / nbas
